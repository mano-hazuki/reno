...
export function PaddingProperty() {
	...
	const updateLeft = (event: ChangeEvent<HTMLInputElement>) => {
		...
		setElements((prev) => {
			...
			prev.find((e) => e.id === elementId)!.padding!.left = Number.parseInt(event.target.value);
		});
	};
	...
	const updateRight = (event: ChangeEvent<HTMLInputElement>) => {
		...
		setElements((prev) => {
			...
			prev.find((e) => e.id === elementId)!.padding!.right = Number.parseInt(event.target.value);
		});
	};
	...
	const updateBottom = (event: ChangeEvent<HTMLInputElement>) => {
		...
		setElements((prev) => {
			...
			prev.find((e) => e.id === elementId)!.padding!.bottom = Number.parseInt(event.target.value);
		});
	};
	return (
